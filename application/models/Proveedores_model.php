...
class Proveedores_model extends CI_Model {
	...
	public function exist_supplier_rut($supplier_rut) {
		...
		$query = $this->db->query('SELECT id FROM supplier WHERE deleted != 1 AND rut = "' . $supplier_rut . '" LIMIT 1');
