				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<h1 class="page-title txt-color-blueDark">
							...
							<span>>
								Transacción Cliente N° <?= $datos['pays'][0]['advance_client_id'] ?>
							</span>
							<span>
										...
										<table id="datatable_tabletools" class="table table-striped table-bordered table-hover">
											...
											<tbody id="tbody">
												...
												<?php 
													...
													foreach ($datos['pays'] as $key => $value) {
						...
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title">
									<span><i class="fa fa-book"></i></span> Registrar pago Transacción N° <?= $datos['pays'][0]['advance_client_id']; ?>
								</h4>
							</div>
							<div class="modal-body no-padding">

								<form id="pay-form" class="smart-form" action="javascript:new_pay()">
									<input type="hidden" name="advance_client_id" value="<?= $datos['pays'][0]['advance_client_id']; ?>">
