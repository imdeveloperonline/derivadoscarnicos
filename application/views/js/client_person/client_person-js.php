 <!-- PAGE RELATED PLUGIN(S) -->
         ...
         if(form.valid()){
          ...
          var params = {
                ...
                "position" : $('input[name="person_position'+n+'"]').val()
				 ...
				 $.ajax({
                      data:  {data:params},
                      url:   '<?= base_url(); ?>clientes/update_client_person',
                      type:  'post',
                      beforeSend: function () {
    ...
    <script>
      function delete_person() {
        ...
        $.ajax({
              data:  {data:params},
              url:   '<?= base_url(); ?>clientes/delete_client_person',
              type:  'post',
              success:  function (response) {
                      $("#message").remove();
                      $(response).appendTo('#resultado');
    ...
    <script>
      ...
      function new_person_client(client_id) {
         ...
         $.ajax({
                data:  {data:params},
                url:   '<?= base_url(); ?>clientes/new_person_client/'+client_id,
                type:  'post',
                beforeSend: function () {
