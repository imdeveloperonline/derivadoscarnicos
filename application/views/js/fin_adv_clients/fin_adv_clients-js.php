		...
		<script>
			function fillTable() {
				...
				$.ajax({
					url: "<?= base_url() ?>finanzas/get_last_adv_client",
		...
		<script>
	      ...
	      function new_adv_client() {
	         ...
	         $.ajax({
	                data:  {data:params},
	                url:   '<?= base_url(); ?>finanzas/new_adv_client',
	                type:  'post',
	                beforeSend: function () {
	    ...
	    <script>
	    	function archived() {
	    		...
	    		$.ajax({
	    			data: {data:params},
	    			url : "<?= base_url() ?>finanzas/archive_adv_client",
	    			type: "post",
	    			success : function(response) {
	    				$("#message").remove();
                        $(response).appendTo('#resultado');
