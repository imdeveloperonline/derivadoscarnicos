		...
		<script>
			...
			function set_modal (id,name, department_id) {
				$('input[name="city_id"]').val(id);
				$('input[name="city_name"]').val(name);
				$('select[name="department_city"]').val(department_id);
		...
		<script>
			...
			function update_location() {
				...
				var params = {
						"id" : $('input[name="city_id"]').val(),
		                "name" : $('input[name="city_name"]').val(),
		                "department_id" : $('select[name="department_city"]').val()
		        };

				$.ajax({
                      data:  {data:params},
                      url:   '<?= base_url(); ?>lugares/update_city',
                      type:  'post',
                      beforeSend: function () {
                      	$("#button").html("<i class='fa fa-spinner fa-spin'></i>");
                      },
