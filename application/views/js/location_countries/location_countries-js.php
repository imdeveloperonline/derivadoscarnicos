		...
		<script>
			...
			function new_location() {
				...
				$.ajax({
                      data:  {data:params},
                      url:   '<?= base_url(); ?>lugares/set_country',
                      type:  'post',
                      beforeSend: function () {
		...
		<script>
			...
			function update_location() {
				...
				var params = {
						"id" : $('input[name="country_id"]').val(),
		                "name" : $('input[name="country_name"]').val()
		        };

				$.ajax({
                      data:  {data:params},
                      url:   '<?= base_url(); ?>lugares/update_country',
                      type:  'post',
                      beforeSend: function () {
                      	$("#button").html("<i class='fa fa-spinner fa-spin'></i>");
                      },
