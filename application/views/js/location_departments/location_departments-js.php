		...
		<script>
			...
			function new_location() {
				...
				$.ajax({
                      data:  {data:params},
                      url:   '<?= base_url(); ?>lugares/set_department',
                      type:  'post',
                      beforeSend: function () {
		...
		<script>
			...
			function set_modal (id,name, country_id) {
				$('input[name="department_id"]').val(id);
				$('input[name="department_name"]').val(name);
				$('select[name="country_department"]').val(country_id);
		...
		<script>
			...
			function update_location() {
				...
				var params = {
						"id" : $('input[name="department_id"]').val(),
		                "name" : $('input[name="department_name"]').val(),
		                "country_id" : $('select[name="country_department"]').val()
		        };

				$.ajax({
                      data:  {data:params},
                      url:   '<?= base_url(); ?>lugares/update_department',
                      type:  'post',
                      beforeSend: function () {
                      	$("#button").html("<i class='fa fa-spinner fa-spin'></i>");
                      },
