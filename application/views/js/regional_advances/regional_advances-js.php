		...
		<script>
			function fillTable(id) {
				...
				$.ajax({
					url: "<?= base_url() ?>regionales/get_last_adv_regional/"+id,
		...
		<script>
	      ...
	      function new_adv_regional() {

	          var params = {

	                "regional_id" : $('input[name="regional_id"]').val(),
	         ...
	         $.ajax({
	                data:  {data:params},
	                url:   '<?= base_url(); ?>regionales/new_adv_regional',
	                type:  'post',
	                beforeSend: function () {
