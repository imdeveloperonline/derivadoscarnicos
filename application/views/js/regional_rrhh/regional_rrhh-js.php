		...
		<script>
			function fillTable() {
				...
				$.ajax({
					url: "<?= base_url() ?>regionales/get_last_employee",
		...
		<script>
			...
			function new_employee() {
				...
				$.ajax({
                      data:  {data:params},
                      url:   '<?= base_url(); ?>regionales/set_new_employee',
                      type:  'post',
                      beforeSend: function () {
		...
		<script>
			...
			function set_modal (id) {
				$('input[name="employee_delete"]').val(id);
		...
		<script>
			...
			function delete_employee() {        
		        ...
		        var params = {
		          "id" : $('input[name="employee_delete"]').val()
		        }

		        var n = $('input[name="employee_delete"]').val();

		        $.ajax({
		              data:  {data:params},
		              url:   '<?= base_url(); ?>regionales/delete_employee',
		              type:  'post',
		              success:  function (response) {
		                      $("#message").remove();
		                      $(response).appendTo('#resultado');
