		...
		<script>
			...
			function set_modal (id) {
				$('input[name="shamble_delete"]').val(id);
		...
		<script>
			...
			function delete_shamble() {        
				
		        var params = {
		          "id" : $('input[name="shamble_delete"]').val()
		        }

		        var n = $('input[name="shamble_delete"]').val();

		        $.ajax({
		              data:  params,
		              url:   '<?= base_url(); ?>frigorificos/delete_shamble',
		              type:  'post',
		...
		<script>
			function fillTable() {
				...
				$.ajax({
					url: "<?= base_url() ?>frigorificos/get_last_shamble",
					success: function (response) {
		...
		<script>
	      ...
	      function new_shamble() {
	         ...
	         $.ajax({
	                data:  {data:params},
	                url:   '<?= base_url(); ?>frigorificos/new_shamble',
	                type:  'post',
	                beforeSend: function () {
	                        $("#buttonNewShamble").html("<i class='fa fa-spinner fa-spin'></i>");
	                },
	                success:  function (response) {
	                        $("#message").remove();
	                        ...
	                        $(response).appendTo('#resultado');
	                        $("#message").hide().fadeIn('slow');
	                        $("#buttonNewShamble").html("Registrar");
	                        $("#close").click();
