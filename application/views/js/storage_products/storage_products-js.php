		...
		<script>
			...
			function selectable(id,selectable) {
				...
				var params = {
		         ...
		         $.ajax({
		                data:  {data:params},
		                url:   '<?= base_url(); ?>bodega/set_selectable_product',
		                type:  'post',
		...
		<script>
			function fillTable() {
				...
				$.ajax({
					url: "<?= base_url() ?>bodega/get_last_product",
					success: function (response) {
		...
		<script>
	      ...
	      function new_product() { 
	         ...
	         $.ajax({
	                data:  {data:params},
	                url:   '<?= base_url(); ?>bodega/set_product',
	                type:  'post',
	                beforeSend: function () {
	    ...
	    <script>
	      ...
	      function edit_product() { 
	         ...
	         $.ajax({
	                data:  {data:params},
	                url:   '<?= base_url(); ?>bodega/update_product',
	                type:  'post',
	                beforeSend: function () {
	                        $("#buttonEditProduct").html("<i class='fa fa-spinner fa-spin'></i>");
	                },
	                success:  function (response) {
	                        $("#message").remove();
	                        $(".dataTables_empty").parent().fadeOut('slow');
	                        $(response).appendTo('#resultado');
	                        $("#message").hide().fadeIn('slow');
	                        $("#buttonEditProduct").html("Guardar cambios");
	                        $("#close-edit").click();
