 <!-- PAGE RELATED PLUGIN(S) -->
         ...
         if(form.valid()){
          ...
          var params = {
                ...
                "position" : $('input[name="person_position'+n+'"]').val()
				 ...
				 $.ajax({
                      data:  {data:params},
                      url:   '<?= base_url(); ?>proveedores/update_supplier_person',
                      type:  'post',
                      beforeSend: function () {
    ...
    <script>
      function delete_person() {
        ...
        $.ajax({
              data:  {data:params},
              url:   '<?= base_url(); ?>proveedores/delete_supplier_person',
              type:  'post',
              success:  function (response) {
                      $("#message").remove();
                      $(response).appendTo('#resultado');
    ...
    <script>
      ...
      function new_person(supplier_id) {
         ...
         $.ajax({
                data:  {data:params},
                url:   '<?= base_url(); ?>proveedores/new_person_supplier/'+supplier_id,
                type:  'post',
                beforeSend: function () {
