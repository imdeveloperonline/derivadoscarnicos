		...
		<script>
			function fillTable() {
				...
				$.ajax({
					url: "<?= base_url() ?>proveedores/get_last_supplier",
					success: function (response) {
		...
		<script>
	      ...
	      function new_supplier() {
	         ...
	         $.ajax({
	                data:  {data:params},
	                url:   '<?= base_url(); ?>proveedores/new_supplier',
	                type:  'post',
	                beforeSend: function () {
	                        $("#buttonNewSupplier").html("<i class='fa fa-spinner fa-spin'></i>");
	                },
	                success:  function (response) {
	                        $("#message").remove();
	                        ...
	                        $(response).appendTo('#resultado');
	                        $("#message").hide().fadeIn('slow');
	                        $("#buttonNewSupplier").html("Registrar");
	                        $("#close").click();
