				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark">
							...
							<span>
								<a data-toggle="modal" href="#myModal"><i class="fa fa-plus-circle" title="Registrar Nueva Ciudad"></i></a>
							</span>
						</h1>
					</div>
													...
													foreach ($datos['cities'] as $key => $value) {
														...
														?>
															<tr id="tr_<?= $value['id'] ?>">
																...
																<td>													
																	&nbsp;
																	<a href="#update-location-modal" title="Editar Ciudad" onclick="set_modal(<?= $value['id'] ?>,'<?= $value['name'] ?>', <?= $value['department_id'] ?>)" data-toggle="modal">
						...
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title">
									<span><i class="fa fa-map-marker"></i></span> Nueva Ciudad
								</h4>
							</div>
							<div class="modal-body no-padding">
								...
								<form id="new-location-form" class="smart-form" action="javascript:new_location()">
									<fieldset>
											...
											<section class="col col-6">
												<label class="input">
													<select name="department" style="width: 100%" class="select2" required>
														<optgroup>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">
							<span><i class="fa fa-map-marker"></i></span> Editar Ciudad
						</h4>
					</div>
					<div class="modal-body no-padding">
							...
							<fieldset>
								<section class="col col-6">
									...
									<label class="input"> <i class="icon-prepend fa fa-map-marker"></i>
										<input type="text" name="city_name" placeholder="Nombre" required>
									</label>
								</section>
									<section class="col col-6">
										<label class="label"><strong>Departamento</strong></label>
										<label class="input">
											<select name="department_city" style="width: 100%" class="select2" required>
												<optgroup>
												<option value="" selected="" disabled="">Departamento</option>
