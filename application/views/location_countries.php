				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark">
							...
							<span>
								<a data-toggle="modal" href="#myModal"><i class="fa fa-plus-circle" title="Registrar Nuevo País"></i></a>
							</span>
						</h1>
					</div>
													...
													foreach ($datos['countries'] as $key => $value) {
														...
														?>
															<tr id="tr_<?= $value['id'] ?>">
																...
																<td>													
																	&nbsp;
																	<a href="#update-location-modal" title="Editar País" onclick="set_modal(<?= $value['id'] ?>,'<?= $value['name'] ?>')" data-toggle="modal">
						...
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title">
									<span><i class="fa fa-map-marker"></i></span> Nuevo País
								</h4>
							</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">
							<span><i class="fa fa-map-marker"></i></span> Editar País
						</h4>
					</div>
					<div class="modal-body no-padding">
							...
							<fieldset>
								<section>
									...
									<label class="input"> <i class="icon-prepend fa fa-map-marker"></i>
										<input type="text" name="country_name" placeholder="Nombre" required>
									</label>
								</section>
