						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-0" data-widget-editbutton="false" data-widget-deletebutton="false">
								<header>
									...
									<h2 class="hidden-xs">Tipos de Gastos</h2>
										...
										<table id="datatable_tabletools" class="table table-striped table-bordered table-hover">
											...
											<tbody id="tbody">
												...
												<?php 
													...
													foreach ($datos['outgoes_types'] as $key => $value) {
														...
														?>
															<tr id="tr_<?= $value['id'] ?>">
																...
																<td>
																	...
																	&nbsp;
																	<a href="#modal-edit" data-toggle="modal" title="Editar Tipo de Gasto" onclick="javascript:set_modal(<?= $value['id'] ?>)">
						...
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title">
									<span><i class="fa fa-book"></i></span> Nuevo tipo de gasto
								</h4>
							</div>
							<div class="modal-body no-padding">

								<form id="otype-form" class="smart-form" action="javascript:new_oType()">
									...
									<footer>
										<button type="submit" id="buttonNewOT" class="btn btn-primary">
											Registrar
										</button>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title">
									<span><i class="fa fa-pencil"></i></span> Editar Tipo de Gasto
								</h4>
							</div>
							<div class="modal-body no-padding">

								<form id="edit-oType-form" class="smart-form" action="javascript:edit_oType()">
									...
									<footer>
										<button type="submit" id="buttonEditOT" class="btn btn-primary">
											Guardar cambios
										</button>
										<button type="button" class="btn btn-default" data-dismiss="modal">
											Cancelar
