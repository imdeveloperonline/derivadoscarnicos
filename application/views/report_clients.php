					...
					<div class="widget-body no-padding">
						...
						<form id="report-form" class="smart-form" novalidate="novalidate" action="javascript:send_form()">
							...
							<fieldset>
								...
								<section>
									<label class="label"><strong>Seleccione un cliente</strong></label>
									<label class="input">
										<select name="client" style="width:100%;" class="select2" required="required">
											<optgroup>							
												<option value="" selected="" disabled="">Ningún cliente seleccionado</option>					
												<?php 
