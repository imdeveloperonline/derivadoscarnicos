					...
					<div class="widget-body no-padding">
						...
						<form id="report-form" class="smart-form" novalidate="novalidate" action="javascript:send_form()">
							...
							<fieldset>
								...
								<section>
									<label class="label"><strong>Seleccione un proveedores</strong></label>
									<label class="input">
										<select name="supplier" style="width:100%;" class="select2" required="required" data-placeholder="Ningún proveedor seleccionado">
											<option></option>
											<optgroup>																	
												<?php 
