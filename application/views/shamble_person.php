	...
	<div class="row">
		<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
			<h1 class="page-title txt-color-blueDark">
				...
				<span>>  
					<strong class="text-uppercase"><?= $datos[0]['tradename']; ?></strong>
				</span>
				<span>
		...
		<?php 
					...
					<div id="content">
						<div id="message" class="alert alert-block alert-info">
							...
							<p>
								No existen personas de contacto registradas para este frigorifico
							</p>
						</div>
					</div>
					<?php
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">
							<span><i class="fa fa-user"></i></span> Nueva Persona de Contacto <i>para</i> <strong class="text-uppercase"><?= $datos[0]['tradename']; ?></strong>
						</h4>
					</div>
					<div class="modal-body no-padding">

						<form id="new-person-form" class="smart-form" action="javascript:new_person(<?= $datos[0]['id']; ?>)">
									<fieldset>
										<div class="row">
											<section class="col col-6">
												<label class="input"> <i class="icon-prepend fa fa-user"></i>
