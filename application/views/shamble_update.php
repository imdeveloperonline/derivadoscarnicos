	...
	<div class="row">
		<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
			<h1 class="page-title txt-color-blueDark">
				...
				<span>>  
					<strong class="text-uppercase"><?= $datos['shamble'][0]['tradename']; ?></strong>
				</span>
			</h1>
		</div>	
	</div>
...
<section id="widget-grid" class="">
	...
	<div class="row">
		...
		<?php foreach ($datos['shamble'] as $key => $value) { 
				...
				<div>
					...
					<div class="widget-body no-padding">
						...
						<form id="update-supplier-form" class="smart-form" novalidate="novalidate" action="javascript:send_form()">
							...
							<header>
								<span><i class="fa fa-shopping-cart"></i></span> <strong><?= $value['tradename']; ?></strong>
							</header>							
								...
								<div class="row">
									<section class="col col-6">
										...
										<label class="input"> <i class="icon-prepend fa fa-shopping-cart"></i>
											<input type="text" name="tradename" placeholder="Nombre" value="<?= $value['tradename'] ?>" required>
										</label>										
									</section>
									<section class="col col-6">
										...
										<select name="city" style="width: 100%" class="select2" required onchange="javascript:hide_locations()">
											...
											<?php 
												...
												foreach ($datos['cities'] as $key_city => $value_city) {				
														...
														if($value['shamble_city_id'] == $value_city['id']) {
															?>
