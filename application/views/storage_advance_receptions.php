					...
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-6">
						<h1 class="page-title txt-color-blueDark">
							<i class="fa fa-archive fa-fw "></i> 
								Recepciones
							<span>>
								<?= $datos['advance_receptions'][0]['supplier_name'] ?> (Anticipo N° <?= $datos['advance_receptions'][0]['advance_supplier_id'] ?>)
							</span>
						</h1>
					</div>
						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-0" data-widget-editbutton="false" data-widget-deletebutton="false">
								<header>
									...
									<h2 class="hidden-xs">Recepciones (<?= $datos['advance_receptions'][0]['supplier_name'] ?>)</h2>
										...
										<table id="datatable_tabletools" class="table table-striped table-bordered table-hover">
											...
											<tbody id="tbody">
												...
												<?php 
													...
													foreach ($datos['advance_receptions'] as $key => $value) {
									...
									<fieldset>
										<div class="row">
											<section class="col col-6">
												...
												<label class="input">
													<select name="advance_supplier_id" style="width: 100%" class="select2" required>
														<optgroup>
														...
														<?php 
															...
															foreach ($datos['client_advances'] as $key => $value) {
																?>
																	<option value="<?= $value['id']; ?>"><?= $value['supplier_name'].' | Cantidad: '.$value['quantity'].' | Fecha: '.date('d-m-Y',strtotime($value['date'])); ?></option>
																<?php
															}
										...
										<section>
											...
											<label class="input">
												<select name="send_address_id" style="width: 100%" class="select2" required>
