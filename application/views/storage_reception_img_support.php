								...
								<div>
									...
									<div class="widget-body no-padding">
										<table id="datatable_tabletools" class="table table-striped table-bordered table-hover">
											...
											<tbody id="tbody">
												<?php 
												foreach ($datos['receptions_imgs'] as $key => $value) {
													...
													<tr id="tr_<?= $value['id'] ?>">
														...
														<td>
															<span>
															<a href="#imgModal" data-toggle="modal" onclick="fillImg('<?= $value['file_name'] ?>')"><img style="height: 75px;width: auto;display: block;margin-left: auto; margin-right: auto;" src="<?= base_url() ?>assets/supports/receptions/thumbs/<?= $value['file_name'] ?>"></a>
															</span>
