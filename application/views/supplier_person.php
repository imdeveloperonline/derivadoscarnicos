	...
	<div class="row">
		<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
			<h1 class="page-title txt-color-blueDark">
				...
				<span>>  
					<strong class="text-uppercase"><?= $datos[0]['supplier_name']; ?></strong>
				</span>
				<span>
			...
			<div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false" data-widget-custombutton="false">
				...
				<div>
					...
					<div class="widget-body no-padding">
						...
						<form id="update-person-form<?= $n ?>" class="smart-form person-form" novalidate="novalidate" action="javascript:update_person(<?= $n ?>)">
		...
		<?php 
					...
					<div id="content">
						<div id="message" class="alert alert-block alert-info">
							...
							<p>
								No existen personas de contacto registradas para este proveedor
							</p>
						</div>
					</div>
					<?php
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">
							<span><i class="fa fa-user"></i></span> Nueva Persona de Contacto <i>para</i> <strong class="text-uppercase"><?= $datos[0]['supplier_name']; ?></strong>
						</h4>
					</div>
					<div class="modal-body no-padding">

						<form id="new-person-form" class="smart-form" action="javascript:new_person(<?= $datos[0]['supplier_id']; ?>)">
									<fieldset>
										<div class="row">
											<section class="col col-6">
												<label class="input"> <i class="icon-prepend fa fa-user"></i>
